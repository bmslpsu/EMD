function [eye_sample, HR_Motion] = emd_sim(eye_filt, Pattern, frame_positions, samp_rate, tc)
%% emd_sim: simulate the flight arena, requires eye_filt map, the Pattern to display,
