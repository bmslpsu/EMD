%% EMD Simulation testing affetc of spatial wavelength
clear ; close all ; clc
...
wavelength = 3.75*[1, 2, 4, 8, 12, 16, 24, 32];
...
ax(1) = subplot(2,1,1); hold on
    ...
    leg = legend(strcat(string(wavelength),char(176)));
    leg.Box = 'off';
...
ax(2) = subplot(2,1,2); hold on
    ...
    for kk = 1:n_wave
       plot(vel(:,kk), [sim_data(:,kk).HR_ss], 'o-', 'Color', CC(kk,:), 'LineWidth', 2, 'MarkerSize', 3)
    end
