...
imageHeight     = 1;      % height of input visual field
...
self = EMD_2(model, acceptAngle, 4.5, delay);
...
set([ax,ax_vel],'FontSize',8,'XGrid','on','YGrid','on', 'LineWidth',1.5)
